...
export function ConsultaBalanceTab({ departmentIds, departments, selectedDepartment, onDepartmentChange }: Props) {
      ...
      <CardHeader className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Consulta el balance de horas de los trabajadores
            </CardDescription>
          </div>
